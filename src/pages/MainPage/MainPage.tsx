    ...
    <Container>
      ...
      <ContainerMain>
        ...
        <main className="Main">
          ...
          <PostItem postText="ada" regDate="asdas"  userName="asdasd" isLiked isMarked/>
            {postList?.message.length && postList.message.map((elem) => (
              <PostItem postText={elem.main_text} regDate={elem.reg_date}  userName={elem.user_fk.name}/>
            ))}
        </main>
